...
<head>
    <meta charset="UTF-8">
    <title>Clinic Login - Doctors</title>
    <style>
        body {
        ...
        .image-box {
            width: 50%;
            background: url('https://images.unsplash.com/photo-1581595219315-a187dd40c322?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80') center/cover no-repeat;
            position: relative;
        }

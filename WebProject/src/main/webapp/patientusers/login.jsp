...
<head>
    ...
    <style>
        ...
        .image-box {
            width: 50%;
            background: url('https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80') center/cover no-repeat;
            position: relative;
        }
...
<div class="container">
    <div class="form-box">
        ...
        <div class="links">
            <a href="<%= request.getContextPath() %>/patientusers/register.jsp">
                <i class="fas fa-user-plus"></i> Δεν έχετε λογαριασμό; Δημιουργήστε!
            </a>
        </div>
    </div>

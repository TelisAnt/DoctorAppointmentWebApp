...
<div class="sidebar">
    ...
    <a href="${pageContext.request.contextPath}/patient/profile" class="active">Προφίλ</a>
...
<div class="content">
    <div class="profile-container">
        <h1>Καλωσήρθες, ${patient.name} ${patient.surname}!</h1>

        <div class="profile-info">
            <div class="info-item">
                <span class="info-label">Username:</span>
                <span class="info-value">${patient.username}</span>
            </div>
            <div class="info-item">
